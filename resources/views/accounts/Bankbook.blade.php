    ...
    <div class="col-md-10">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">{{__('BANK BOOK FORM')}}</h3>
            </div>
            <form method="post" action="{{ route('BankbookView') }}" class="form-horizontal">
                {{csrf_field()}}
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="bankbook" class="col-sm-2 control-label">{{__('Bank Book')}} <span
                                style="color:red">*</span></label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="bankbook" placeholder="select bank book">
                        </div>
                    </div>
                    <div class="form-group">
